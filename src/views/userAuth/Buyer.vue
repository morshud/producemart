<template>
<title>Buyer Registration | Produce Mart</title>
    <section class="reg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="imageArea imageBuyer">
                        <img class="image11" ondragstart="return false;" src="@/assets/img/dashboard-img/image11.png">
                        <img class="image22" ondragstart="return false;" src="@/assets/img/dashboard-img/image22.png">
                        <img class="image33" ondragstart="return false;" src="@/assets/img/dashboard-img/image33.png">
                    </div>
                </div>
                        ...
                        <form @submit.prevent="handleRegister">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-2 text-center signuas">
                                    <router-link to="/supplier-registration" class="route-link" :disabled="loading">Sign Up as a Supplier</router-link>
                                </div>
                            </div>
                        </form>
                    </div>
