  ...
  <section class="reg">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-5">
          <div class="imageArea">
            <img
              ...
              src="@/assets/img/dashboard-img/image1.png"
            />
            <img
              class="image2"
              ondragstart="return false;"
              src="@/assets/img/dashboard-img/image2.png"
            />
            <img
              class="image3"
              ondragstart="return false;"
              src="@/assets/img/dashboard-img/image3.png"
            />
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="signupDiv">
            <form @submit.prevent="handlesupplier">
              <div
                v-if="message"
                class="alert"
              ...
              <div class="row">
                ...
                <div class="col-lg-12 mb-4">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <i class="bi bi-building"></i>
                      <select v-model="user.country" required class="input">
                ...
                <div class="col-lg-12 agreement">
                  <p>
                    ...
                    <router-link to="#" class="route-link">Terms</router-link> &
                ...
                <div class="col-lg-12 mt-2 text-center signuas">
                  <router-link
                    ...
                    class="route-link"
                    :disabled="loading"
                    >Sign Up as a Buyer</router-link
                  >
                </div>
              </div>
            </form>
...
export default {
  ...
  methods: {
    handlesupplier() {
      ...
      this.$store.dispatch("auth/supplier", this.user).then(
        (data) => {
        ...
        (error) => {
          this.message =
            ...
            "password does not match or too short";
          /* error.toString(); */
