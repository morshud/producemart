                        ...
                        <form @submit.prevent="handleLogin">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-12 mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <input v-model="user.email" name="email"  type="text" placeholder="Enter username or email" class="input">
                                        </div>
                                    </div>
                                </div>
                                <!--Password-->
                                <div class="col-lg-12 mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="password" v-model="user.password" name="password" placeholder="Enter your password" class="input">
                                            <span class="forgot"><router-link to="/forgot-password" class="route-link">Forgot Password?</router-link></span>
                                        </div>
                                    </div>
                                </div>
                                <!--Kepp me logged in-->
                                ...
                                <div class="col-lg-12 text-center optionBelow2 mb-4">
                                    <router-link to="/supplier-registration" class="route-link"><a>A Supplier</a></router-link>
                                    <router-link to="/buyer-registration" class="route-link"><a>A Buyer</a></router-link>
                                </div>
                            </div>
                        </form>
                    </div>
