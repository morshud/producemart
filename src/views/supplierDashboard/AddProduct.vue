<template>
  <title>Add Products - Supplier Dashboard | Produce Mart</title>
  <dash-sidebar />
                ...
                <div class="col-lg-4">
                  <div class="dashboard_breadcam text-right">
                    <p>
                      ...
                      >
                      <i class="fas fa-caret-right"></i> Add Products
                    </p>
                  </div>
                </div>
              </div>
            ...
            <form class="form">
              ...
              <div class="row form-step">
                ...
                <div class="row mt-4 mb-3">
                  ...
                  <!--Oil Category-->
                  <div class="row mt-1 categoryDiv" v-show="oil">
                  ...
                  <!--Fruit Category-->
                  <div class="row mt-1 categoryDiv" v-show="fruit">
                    <div class="col-lg-12 mb-2">
                  ...
                  <!--Vegetable Category-->
                  <div class="row mt-1 categoryDiv" v-show="vegetable">
                    <div class="col-lg-12 mb-2">
                  ...
                  <div class="row mt-1 categoryDiv" v-show="grain">
                    <div class="col-lg-12 mb-2">
                  ...
                  <!--Nuts/Seeds Category-->
                  <div class="row mt-1 categoryDiv" v-show="nut">
                    <div class="col-lg-12 mb-2">
                  ...
                  <!--Coffee Category-->
                  <div class="row mt-1 categoryDiv" v-show="coffee">
                    <div class="col-lg-12 mb-2">
                  ...
                  <!--Flower Category-->
                  <div class="row mt-1 categoryDiv" v-show="flower">
                    <div class="col-lg-12 mb-2">
                  ...
                  <div class="row mt-1 categoryDiv" v-show="animalFeed">
                    <div class="col-lg-12 mb-2">
                  ...
                  <!--Others Category-->
                  <div class="row mt-1 categoryDiv" v-show="others">
                    <div class="col-lg-12 mb-2">
                      <h3>Others</h3>
                      <div class="lineHr"></div>
                    </div>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <button type="submit" class="btn btn-prev width-100">
                      Previous
                    </button>
                  </div>
                  <div class="col-sm-6">
                    <button type="submit" class="btn btn-next width-100">
                      Next
                    </button>
                  </div>
                  <div class="col-sm-12">
              ...
              <div class="row form-step">
                ...
                <div class="col-lg-12 mt-4 mb-3">
                  ...
                  />
                  <small class="uploadSmallPicture"
                    >You can select multiple pictures (accepted image format:
                    jpeg, jpg, png, webp)</small
                  >
                </div>
                <div class="row">
                  <div class="col-sm-6">
