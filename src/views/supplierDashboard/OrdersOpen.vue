                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="dashboard_breadcam text-right">
                                        <p>
                                            <router-link to="/supplier-dashboard/home"><a>Dashboard</a></router-link> <i class="fas fa-caret-right"></i> Open Orders
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="QA_table mb_30">
                                        <table class="table lms_table_active ">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="/supplier-dashboard/view-open-order" class="viewOrder">View Order</a></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">01-May-2022</th>
                                                <td>Cocoa - QBL1878</td>
                                                <td>10 bags</td>
                                                <td><a class="btn-inspection">Inspection</a></td>
