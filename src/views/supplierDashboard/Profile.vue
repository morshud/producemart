<template>
    <title>My Profile - Supplier Dashboard | Produce Mart</title>
    <dash-sidebar/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="dashboard_breadcam text-right">
                                        <p>
                                            <router-link to="/supplier-dashboard/home"><a>Dashboard</a></router-link> <i class="fas fa-caret-right"></i> Profile
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-10 white_box myProfile">
                        <div class="row">
                            ...
                            <div class="col-sm-12 mt-4">
                                <router-link class="route-link" to="/supplier-dashboard/edit-profile-details">Edit Profile Details</router-link>
                            </div>
                        </div>
                    </div>
                </div>
