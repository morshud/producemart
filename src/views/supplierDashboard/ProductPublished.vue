                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="dashboard_breadcam text-right">
                                        <p>
                                            <router-link to="/supplier-dashboard/home"><a>Dashboard</a></router-link> <i class="fas fa-caret-right"></i> Published Products
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="QA_table mb_30">
                                        <table class="table lms_table_active ">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action_btns d-flex">
                                                        <a href="/supplier-dashboard/view-products" title="View & Edit" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action_btns d-flex">
                                                        <a href="#" title="View & Edit" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                        <a href="#" title="Delete" class="action_btn"> <i class="fas fa-trash"></i> </a>
                                                    </div>
                                                </td>
                                            </tr>
