                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="dashboard_breadcam text-right">
                                        <p>
                                            <router-link to="/supplier-dashboard/home"><a>Dashboard</a></router-link> <i class="fas fa-caret-right"></i> View All Address
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="QA_table mb_30">
                                        <table class="table lms_table_active ">
                                            ...
                                            <tr>
                                                <th scope="row">1</th>
                                                <td>Head Quarters</td>
                                                <td>No 1, Anifowose Street, Off Papa Ajayi Cresent, Tawakalitu State, Nigeria.</td>
                                                <td>
                                                    <div class="action_btns d-flex">
                                                        <router-link to="/supplier-dashboard/edit-address">
                                                            <a title="Edit" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                        </router-link>
