        ...
        <div class="main_content_iner ">
            <div class="container-fluid p-0">
                <div class="row justify-content-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="dashboard_breadcam text-right">
                                        <p>
                                            <router-link to="/supplier-dashboard/home"><a>Dashboard</a></router-link> <i class="fas fa-caret-right"></i> <router-link to="/supplier-dashboard/open-orders"><a>Open Orders</a></router-link> <i class="fas fa-caret-right"></i> Order Product Name Here
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            <router-link to="/supplier-dashboard/open-orders" class="backToPage"><i class="bi bi-arrow-bar-left"></i> Back to Open Orders</router-link>
                        </div>
                                                    ...
                                                    <div class="col-12 boxWhite">
                                                        ...
                                                        <div class="row mt-4 text-center">
                                                            <div class="col-lg-4 mb-3">
                                                                <input type="radio" @click="quantityRequested();" name="quantity" id="yesSupply">
                                                                <label for="yesSupply">Yes, I have</label>
                                                            </div>
                                                            <div class="col-lg-4 mb-3">
                                                                <input type="radio" @click="quantityRequested();" name="quantity" id="noSupply">
                                                                <label for="noSupply">No, I don't have</label>
                                                            </div>
                                                            <div class="col-lg-4 mb-3">
                                                                <input type="radio" @click="quantityRequested();" name="quantity" id="lessSupply">
                                                                <label for="lessSupply">I have less</label>
                                                            </div>
                                                            <div class="col-lg-12 mb-3" id="iflessSupply">
                                                                <textarea cols="30" rows="3" class="inputTextArea"></textarea>
                                                            </div>
                                                    ...
                                                    <div class="col-12 boxWhite">
                                                        <div class="row justify-content-center">
                                                            <div class="col-lg-8 text-center">
                                                                <img src="@/assets/img/dashboard-img/dashOrderStatus.png">
                                                                <h6>The buyers has paid for your produce into escrow and money will be released once the produce is picked up</h6>
                                            ...
                                            <div class="form-card">
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-12 paymentCom">
                                                        <div class="row justify-content-center pendingPayment">
                                                            <div class="col-lg-8 text-center">
                                                                <img src="@/assets/img/dashboard-img/pendingFund.png">
                                                                <p>Your payment is yet to be released by escrow, once it is relesed you would be notified immediately</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row completedPayment">
                                                        <div class="col-lg-12 text-center mb-3">
                                                            <h3>🎉   Congratulations! You have successfully completed this transaction   🎉</h3>
                                                        </div>
                                                        <div class="row justify-content-center">
                                                            <!--payment summary-->
                                                            <div class="col-lg-5 paymentBox">
                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td>Status:</td>
                                                                        <td><span class="completed">Fund Released</span></td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                            <!--recipients details-->
                                                            <div class="col-lg-5 paymentBox paymentBoxBorder">
                                                                ...
                                                                <h6>Would you like to leave a review about this service?</h6>
