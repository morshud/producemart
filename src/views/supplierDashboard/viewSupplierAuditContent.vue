<template>
  <div>
  <title>View Audit - Supplier Admin Dashboard | Produce Mart</title>
  <dash-sidebar />
    ...
    <div class="main_content_iner">
      <div class="container-fluid p-0">
        <div class="row justify-content-center">
                ...
                <div class="QA_section">
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="text-center" v-if="audit.progress == 'pending' || audit.progress == 'declined'">
                      <button class="btn btn-mart" @click="$router.push('/supplier-dashboard/edit-audit/'+item._id)" type="button">Edit Certificate</button>
                    </div>
                    <!-- <div class="text-center" v-if="audit.progress == 'pending' || audit.progress == 'declined'">
          ...
          <div class="col-12 QA_section mb-4" v-if="audit.progress == 'pending' || audit.progress == 'declined'">
            <div class="white_card card_height_100 mb_30 pt-4">
              <div class="white_card_body">
                <div class="QA_section">
                  <div class="white_box_tittle list_header">
