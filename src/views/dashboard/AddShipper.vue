                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="dashboard_breadcam text-right">
                                        <p>
                                            <router-link to="/dashboard/home"><a>Dashboard</a></router-link> <i class="fas fa-caret-right"></i> Add Shipper
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="white_card_header">
                                <div class="box_header m-0">
                                    <div class="main-title">
                                        <h3 class="m-0">Add New Shipper</h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="create_report_btn mt_30">
                                            <button type="submit" class="btn_1 radius_btn d-block text-center">Add Shipper</button>
                                        </div>
                                        </div>
                                    </div>
                                </form>
