<template>
  <title>Inspector Email - Super Admin Dashboard | Produce Mart</title>
  <dash-sidebar />
                    ...
                    <tr v-for="(mail, i) in mails" :key="i">
                      ...
                      <td>
                        <div class="action_btns d-flex">
                          <router-link
                            :to="'/dashboard/edit-inspector-email/' + mail._id"
                            title="Edit"
...
export default {
  ...
  methods: {
    async fetchEmail() {
      ...
      this.mails = data.filter((mail) => mail.type == "inspector");
      console.log(data);
    },
    async deleteMail(id) {
      const res = await fetch(
