<template>
  <title>Shipping Price - Super Admin Dashboard | Produce Mart</title>
  <dash-sidebar />
                ...
                <div class="col-lg-4">
                  <div class="dashboard_breadcam text-right">
                    <p>
                      ...
                      >
                      <i class="fas fa-caret-right"></i> Shipping Price
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="white_card card_height_100 mb_30 pt-4">
              <div class="white_card_body">
                ...
                <div class="col-lg-12 text-right" @click="saveShipper">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 mb-2">
                      ...
                      <input
                        type="number"
                        class="input"
                        v-model="shipperDetails.air_cost"
                      />
                    </div>
                    <div class="col-lg-6 mb-2">
                      ...
                      <input
                        type="number"
                        class="input"
                        v-model="shipperDetails.air_deposit"
                      />
                    </div>
                    <div class="col-lg-6 mb-2">
                      ...
                      <input
                        type="number"
                        class="input"
                        v-model="shipperDetails.air_insurance"
                      />
                    </div>
                    <div class="col-lg-6 mb-2">
                      ...
                      <input
                        ...
                        v-model="shipperDetails.air_duration"
                      />
                      <select
                        class="custSlt"
                        v-model="shipperDetails.air_duration_period"
                      >
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 mb-2">
                      ...
                      <input
                        type="number"
                        class="input"
                        v-model="shipperDetails.sea_cost"
                      />
                    </div>
                    <div class="col-lg-6 mb-2">
                      <label>initial deposit ($)</label>
                      <input
                        type="number"
                        class="input"
                        v-model="shipperDetails.sea_deposit"
                      />
                    </div>
                    <div class="col-lg-6 mb-2">
                      <label>insurance ($)</label>
                      <input
                        type="number"
                        class="input"
                        v-model="shipperDetails.sea_insurance"
                      />
                    </div>
                    <div class="col-lg-6 mb-2">
                      <label>estimated duration</label>
                      <input
                        type="number"
                        class="input customInput"
                        v-model="shipperDetails.sea_duration"
                      />
                      <select
                        class="custSlt"
                        v-model="shipperDetails.sea_duration_period"
                      >
                        <option value="hours">hours</option>
                        <option value="days">days</option>
                        <option value="weeks">weeks</option>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 mb-2">
                      ...
                      <input
                        type="number"
                        class="input"
                        v-model="shipperDetails.road_cost"
                      />
                    </div>
                    <div class="col-lg-6 mb-2">
                      <label>initial deposit ($)</label>
                      <input
                        type="number"
                        class="input"
                        v-model="shipperDetails.road_deposit"
                      />
                    </div>
                    <div class="col-lg-6 mb-2">
                      <label>insurance ($)</label>
                      <input
                        type="number"
                        class="input"
                        v-model="shipperDetails.road_insurance"
                      />
                    </div>
                    <div class="col-lg-6 mb-2">
                      <label>estimated duration</label>
                      <input
                        type="number"
                        class="input customInput"
                        v-model="shipperDetails.road_duration"
                      />
                      <select
                        class="custSlt"
                        v-model="shipperDetails.road_duration_period"
                      >
                        <option value="hours">hours</option>
                        <option value="days">days</option>
                        <option value="weeks">weeks</option>
...
export default {
  ...
  methods: {
    ...
    saveShipper() {
      this.shipperDetails.shipperId = this.shipperId;
      let orderDetails = JSON.parse(localStorage.getItem("orderDetails"));
      let names = JSON.parse(localStorage.getItem("names"));

      if (orderDetails) {
        orderDetails = { ...orderDetails, ...this.shipperDetails };
        names = { ...names, shipper: this.name };
      } else {
        orderDetails = { ...this.shipperDetails };
        names = { shipper: this.name };
      }
