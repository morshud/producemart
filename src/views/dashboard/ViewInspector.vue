                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="dashboard_breadcam text-right">
                                        <p>
                                            <router-link to="/dashboard/home"><a>Dashboard</a></router-link> <i class="fas fa-caret-right"></i> View Inspector
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="QA_section">
                                    ...
                                    <div class="QA_table mb_30">
                                        <table class="table lms_table_active ">
                                            ...
                                            <tbody>
                                            <tr>
                                                <th scope="row">Henry100223</th>
                                                <td>Awesome Agri Life</td>
                                                <td>Henry</td>
                                                <td>Ade</td>
                                                <td>myemail@email.com</td>
                                                <td>08123456789</td>
                                                <td>No 1, street address. Lagos, Nigeria.</td>
                                            ...
                                            <tr>
                                                <th scope="row">Tunde2550</th>
                                                <td>Rooted Seedlings</td>
                                                <td>Tunde</td>
                                                <td>Makinwa</td>
                                                <td>myemail@email.com</td>
                                                <td>08123456789</td>
                                                <td>No 1, street address. Lagos, Nigeria.</td>
                                                <td><a href="#" class="status_btn-danger">Disable</a></td>
                                                <td>
                                                    <div class="action_btns d-flex">
                                                        <a href="#" title="Edit" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                        <a href="#" title="Delete" class="action_btn"> <i class="fas fa-trash"></i> </a>
