                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="dashboard_breadcam text-right">
                                        <p>
                                            <router-link to="/dashboard/home"><a>Dashboard</a></router-link> <i class="fas fa-caret-right"></i> Add Inspector
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="create_report_btn mt_30">
                                            <button type="submit" class="btn_1 radius_btn d-block text-center">Add Inspector</button>
                                        </div>
                                        </div>
                                    </div>
                                </form>
