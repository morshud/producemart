                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="crm_box">
                                        <h4>2,455</h4>
                                        <p>Buyers</p>
                                        <img src="@/assets/img/dashboard-img/dash-buyer.png" ondragstart="return false;">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="crm_box">
                                ...
                                <div class="col-lg-4">
                                    <div class="crm_box">
                                        <h4>100,000</h4>
                                        <p>Products</p>
                                        <img src="@/assets/img/dashboard-img/dash-product.png" ondragstart="return false;">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="crm_box">
                    ...
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body ">
                            <div class="single_user_pil d-flex align-items-center justify-content-between mb-0">
                                ...
                                <div class="thumb_34 mr_15 mt-0"><img class="@/assets/img-fluid radius_50" src="@/assets/img/customers/1.png" alt=""></div>
                            ...
                            <div class="single_user_pil d-flex align-items-center justify-content-between mb-0">
                                <div class="user_pils_thumb d-flex align-items-center">
                                <div class="thumb_34 mr_15 mt-0"><img class="@/assets/img-fluid radius_50" src="@/assets/img/customers/1.png" alt=""></div>
                                <span class="f_s_14 f_w_400 text_color_11">Victor Smart</span>
                                </div>
                                <div class="user_info">
                                Seller
                                </div>
                            ...
                            <div class="single_user_pil d-flex align-items-center justify-content-between mb-0">
                                <div class="user_pils_thumb d-flex align-items-center">
                                <div class="thumb_34 mr_15 mt-0"><img class="@/assets/img-fluid radius_50" src="@/assets/img/customers/1.png" alt=""></div>
                                <span class="f_s_14 f_w_400 text_color_11">Promise Stephen</span>
                                </div>
                                <div class="user_info">
                                Seller
                                </div>
