<template>
  <title>Edit Inspector Mail - Super Admin Dashboard | Produce Mart</title>
  <dash-sidebar />
                ...
                <div class="col-lg-4">
                  <div class="dashboard_breadcam text-right">
                    <p>
                      ...
                      >
                      <i class="fas fa-caret-right"></i> Edit Inspector mail
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="white_card_header">
                <div class="box_header m-0">
                  <div class="main-title">
                    <h3 class="m-0">Edit Inspector Mail</h3>
                  </div>
                </div>
              </div>
              <div class="white_card_body">
                <form @submit.prevent="updateInspectorMail" v-if="mail">
                  <div class="row">
                    <div class="col-lg-12">
