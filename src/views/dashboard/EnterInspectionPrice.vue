    ...
    <section class="main_content dashboard_part large_header_bg">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="dashboard_breadcam text-right">
                                        <p>
                                            <router-link to="/dashboard/home"><a>Dashboard</a></router-link> <i class="fas fa-caret-right"></i> <router-link to="/dashboard/view-quotes"><a>View Quotes</a></router-link> <i class="fas fa-caret-right"></i>  Inspection Price
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="white_card card_height_100 mb_30 pt-4">
                            <div class="white_card_body">
                                <div class="QA_section">
                                    ...
                                    <div class="QA_table mb_30">
                                        <table class="table lms_table_active ">
                                            ...
                                            <tr>
                                                <th scope="row">1</th>
                                                <td>Single Man Operations</td>
                                                <td>justme@me.com</td>
                                                <td><a class="enterPricesBtn" data-bs-toggle="modal" data-bs-target="#inspectorModal">Input Details</a></td>
                                                <td><a class="viewBoxBtn" data-bs-toggle="modal" data-bs-target="#viewModal">View</a></td>
                                                <td>
                                                    <label class="lblCheck">
                                                        <input class="iptCheck" type="radio" name="inspector"/>
                                ...
                                <div class="col-lg-12 text-right">
                                    <router-link to="#" class="backBtn"><i class="bi bi-arrow-left-short"></i> Back to quotes summary</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="inspectorModalLabel">Enter Info For Single Man Operations</h5>
                        ...
                        <form class="priForm">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <input type="number" class="input customInput">
                                    <select class="custSlt">
                                        <option>hours</option>
                                        <option>days</option>
                                        <option>weeks</option>
        ...
        <div class="modal fade" id="viewModal" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="viewModalLabel">Details of Single Man Operations</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
