<template>
  ...
  <main class="resContent">
      <div class="container">
          <div class="row">
              <div class="col-lg-12">
                  <p>Effective date: 2022-08-24</p>
<p>Updated on: 2022-09-19</p>
<p>
...
<p>Producemart is authorized to modify this Privacy Policy at any time.
This may occur without prior notice.</p>
<p>
  Producemart will post the revised Privacy Policy on the www.producemart.com website</p>

    <h3 class="mt-3 mb-3">Collection and Use of Your Personal Information</h3>
    <h4>Information We Collect</h4>
    <p>
      When using our Service, you will be prompted to provide us with personal information used to
contact or identify you. www.producemart.com collects the following information:    </p>
    ...
    <p>
      www.producemart.com collects and receives information from you in the following manner:    </p>
    <ul>
...
personally may be stored indefinitely.    </p>
            ...
            <h4 class="mt-3">How We Use Your Information</h4>
        <p>
          www.producemart.com may use your information for the following purposes:        </p>
        <ul>
                        <li><b>Providing and maintaining our Service,</b> as well as monitoring the usage of our Service.</li>
                        <li><b>For other purposes.</b> Producemart will use your information for data analysis to identify usage
...
have purchased through our Service.</li>
                        <li><b>To contact you.</b> Producemart will contact you by email, phone, SMS, or another form of
...
necessary or reasonable.</li>
                        ...
                        <li><b>Marketing and promotional initiatives.</b> Producemart will use non-specific information gathered
...
website Administration practices.</li>
        ...
        <p>
          Producemart will share your information, when applicable, in the following situations:        </p>
        <ul>
                      <li><b>With your consent.</b> Producemart will share your information for any purpose with your explicit
consent.</li>
                      <li><b>Sharing with other users.</b> Information you provide may be viewed by other users of our Service.
...
on the third-party service may see your information and a description of your activity.</li>
                  </ul>
...
privacy practices of other websites you interact with and determine the adequacy of those practices.    </p>
    ...
    <p>Name: Producemart</p>
    <p>Address: 128 City Road,  London, EC1V 2NX</p>
    <p>Email: contact@producemart.com</p>
    <p>Website: www.producemart.com</p>
              </div>
          </div>
      </div>
  </main>
