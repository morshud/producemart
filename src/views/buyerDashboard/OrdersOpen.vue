                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="dashboard_breadcam text-right">
                                        <p>
                                            <router-link to="/buyer-dashboard/home"><a>Dashboard</a></router-link> <i class="fas fa-caret-right"></i> Open Orders
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="QA_table mb_30">
                                        <table class="table lms_table_active ">
                                            ...
                                            <tr>
                                                ...
                                                <td>Cocoa - QBL1878</td>
                                                <td>01-05-2022</td>
                                                <td><a class="btn-awaiting">Awaiting Quotes</a></td>
                                                <td><a href="/buyer-dashboard/view-open-order" class="viewOrder">View Order</a></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Q60077</th>
                                                <td>Cocoa - QBL1878</td>
