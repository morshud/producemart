    ...
    <main>
        <div class="container">
            <div class="row justify-content-center">
                <img class="snippet" ondragstart="return false;" src="@/assets/img/adminImg/snippet.png">
                <div class="col-lg-7">
                    <div class="loginDiv">
                        <div class="headLogin">
                            <h3>
                        ...
                        <form @submit.prevent="handleLogin">
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-4">
                                    ...
                                    <input  v-model="user.email" type="email" placeholder="Enter your email" class="input">
                                </div>
                                <div class="col-lg-12 mb-4">
                                    <label>Password</label>
                                    <i class="bi bi-lock"></i>
                                    <input v-model="user.password" type="password" placeholder="Enter your password" class="input">
                                </div>
                ...
                <img class="snippet2" ondragstart="return false;" ondr src="@/assets/img/adminImg/snippet2.png">
            </div>
        </div>
    </main>
</template>
